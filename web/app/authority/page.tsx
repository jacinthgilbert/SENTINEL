...
export default function Authority() {
  ...
  if (!sit || !plan) {
    return <main className="wrap wide"><p className="sub">Loading situation…</p></main>;
  }
    ...
    <main className="wrap wide">
      <header className="head">
        <div>
          ...
          <p className="sub">
            The Sentinel · Visakhapatnam ·{" "}
            <Link href="/" className="link">citizen view</Link>
          </p>
        </div>
        <span className="pill">
          {w.mode === "scenario" && <span className="badge">EXERCISE</span>}
          <span className="dot live" />
          {w.rain_mm_hr} mm/hr · gauge {w.gauge_cm} cm
        </span>
      </header>
